...
class Downloader:
    ...
    def get_total_bytes(self,
        ...
        """
        Возвращает общее количество байтов, занимаемых файлом видеоролика,
        указанного формата.
        ...
        Returns:
            Общее количество байтов, занимаемых видеороликом или
            ``None``, если общее количество байтов неизвестно.
        """
        pass
